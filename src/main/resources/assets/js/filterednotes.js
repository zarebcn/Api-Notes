...
function setupSearchButton() {
	 ...
	 let search = document.querySelector(".main .homeinputsearch .search");

	 search.onclick = function() {

		 let input = document.querySelector(".main .homeinputsearch input");
...
function setupHomeButton () {
    ...
    $(".main .homeinputsearch .home").click(function() {
